...
{
    /*
     * This test checks that we can index data, it gets saved to the database,
     * and that a raw query on the database returns the appropriate data. This
     * does not use FieldSearch yet.
     */
    @Test
    public void test_normal_end_to_end()
    {
        ...
        String[] lines = { "names Tom Dylan Wenbin Nicholas", "days Monday Tuesday Wednesday", "classes OOP Algorithms ComputerOrg", "letters a b c d e f g", };
    ...
    public void test_end_to_end_with_same_fields_in_multiple_files()
    {
        ...
        String filename = "test_data.txt";
        String[] lines = { "names Tom Dylan Wenbin Nicholas", "names Tom Dylan Wenbin Nicholas", "days Monday Tuesday Wednesday",
                "days Monday Tuesday Wednesday", "classes OOP Algorithms ComputerOrg", "classes OOP Algorithms ComputerOrg", "letters a b c d e f g",
